...
class RecordAccess(models.Model):
    requested_by = models.ForeignKey(UserProfile, related_name="requestedrecordaccesses", on_delete=models.CASCADE)
    processed_by = models.ForeignKey(UserProfile, related_name="processedrecordaccesses", on_delete=models.CASCADE,
                                     null=True, blank=True)
    record = models.ForeignKey(Record, related_name="e_permissions_requested", on_delete=models.CASCADE)
