...
from apps.internal.models import Article, IndexPage, RoadmapItem, ImprintPage, TomsPage
...
class TomsPageViewSet(mixins.ListModelMixin, GenericViewSet):
