from typing import Callable, Dict, List, Optional, Type, Literal, Any
...
def validation_error_handler(validation_error: ValidationError) -> RFC7807:
    ...
    return RFC7807(detail=form_error,
                   status=422,
    ...
    def generate_view_func(method_route: Dict) -> Callable[..., JsonResponse]:
        def decorator(request: HttpRequest, *args, **kwargs) -> JsonResponse:
            if request.method in method_route:
                ...
                return ErrorResponse(title='Method Not Allowed', status=405, type='MethodNotAllowed')
    ...
    def generate_view(
        ...
        def wrapper(
            ...
            if not result.success:
                ...
                return ErrorResponse(title=result.value, status=400, type='ServiceError')
            ...
            if output_schema:
                ...
                try:
                    ...
                    return ErrorResponse(type='OutputError',
                                         title='Server Error',
                                         internal=e.errors(),
                                         status=500)
