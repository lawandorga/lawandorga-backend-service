...
from apps.api.models import UserProfile, StatisticUser, RlcUser
from apps.api.views import StatisticsUserViewSet
...
class UserBase:
    def setUp(self):
        self.user = UserProfile.objects.create(email='dummy@law-orga.de', name='Dummy 1')
