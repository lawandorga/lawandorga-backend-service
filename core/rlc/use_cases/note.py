...
def create_note(__actor: RlcUser, title: str, note: str):
...
@use_case(permissions=[PERMISSION_DASHBOARD_MANAGE_NOTES])
def update_note(
    __actor: RlcUser, note_id: int, title: str | None = None, note: str | None = None
):
...
@use_case(permissions=[PERMISSION_DASHBOARD_MANAGE_NOTES])
def delete_note(__actor: RlcUser, note_id: int):
