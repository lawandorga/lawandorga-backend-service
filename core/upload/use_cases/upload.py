...
@use_case
def create_upload_link(__actor: RlcUser, name: str, folder_uuid: UUID):
...
@use_case
def disable_upload_link(__actor: RlcUser, link_uuid: UUID):
...
@use_case
def delete_upload_link(__actor: RlcUser, link_uuid: UUID):
    link = link_from_uuid(__actor, link_uuid)
