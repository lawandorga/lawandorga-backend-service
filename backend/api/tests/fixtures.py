...
class CreateFixtures:
    ...
    def create_sample_groups():
        ...
        CreateFixtures.add_group(
            2, "Group2", True, [users[1 % users.__len__()].id, users[0].id]
        )
        CreateFixtures.add_group(
            3,
            "Group3",
            True,
            [users[1 % users.__len__()].id, users[2 % users.__len__()].id],
        )
    ...
    def create_sample_has_permissions():
        ...
        CreateFixtures.add_has_permission(
            3,
            permissions[2].id,
            group_has=groups[0].id,
            for_group=groups[1 % groups.__len__()].id,
        )
        CreateFixtures.add_has_permission(
            4,
            permissions[0].id,
            group_has=groups[2 % groups.__len__()].id,
